...
class UserAdminController extends AbstractActionController
{
    ...
    {
        $users = $this->getEntityManager()->getRepository(\Midnight\User\Entity\User::class)->findAll();
    ...
    {
        return $this->getEntityManager()->find(\Midnight\User\Entity\User::class,
            $this->params()->fromRoute('user_id'));
    }
